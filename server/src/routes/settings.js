...
const SECRET_KEYS = new Set(['ebay_client_secret', 'tcgplayer_api_key', 'price_provider_api_key', 'pokewallet_api_key']);

const PUBLIC_KEYS = [
  'site_title', 'default_theme', 'snapshot_enabled', 'snapshot_hour',
  'price_provider', 'price_provider_api_key', 'pokewallet_api_key',
